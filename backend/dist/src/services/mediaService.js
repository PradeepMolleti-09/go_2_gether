...
exports.deleteTripMedia = exports.listTripMedia = exports.uploadTripPhoto = void 0;
...
const deleteTripMedia = async (mediaId, userId) => {
    const media = await Media_1.Media.findById(mediaId);
    if (!media) {
    ...
    // Delete from DB
    await Media_1.Media.findByIdAndDelete(mediaId);
    return media;
};
exports.deleteTripMedia = deleteTripMedia;
